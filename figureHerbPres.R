...
delta = properties %>% 
  ...
  summarise(plant.rich = first(plant.rich),
            d2_1 = herbivory.pressure[scenario == s2] - herbivory.pressure[scenario == s1],
            d3_1 = herbivory.pressure[scenario == s3] - herbivory.pressure[scenario == s1],
            d4_1 = herbivory.pressure[scenario == s4] - herbivory.pressure[scenario == s1],
            d5_1 = herbivory.pressure[scenario == s5] - herbivory.pressure[scenario == s1],
            d6_1 = herbivory.pressure[scenario == s6] - herbivory.pressure[scenario == s1],
            d3_2 = herbivory.pressure[scenario == s3] - herbivory.pressure[scenario == s2],
            d4_2 = herbivory.pressure[scenario == s4] - herbivory.pressure[scenario == s2],
            d5_2 = herbivory.pressure[scenario == s5] - herbivory.pressure[scenario == s2],
            d6_2 = herbivory.pressure[scenario == s6] - herbivory.pressure[scenario == s2],
            d4_3 = herbivory.pressure[scenario == s4] - herbivory.pressure[scenario == s3],
            d5_3 = herbivory.pressure[scenario == s5] - herbivory.pressure[scenario == s3],
            d6_3 = herbivory.pressure[scenario == s6] - herbivory.pressure[scenario == s3],
            d5_4 = herbivory.pressure[scenario == s5] - herbivory.pressure[scenario == s4],
            d6_4 = herbivory.pressure[scenario == s6] - herbivory.pressure[scenario == s4],
            d6_5 = herbivory.pressure[scenario == s6] - herbivory.pressure[scenario == s5])
...
a = ggplot(properties, 
           aes((plant.rich), herbivory.pressure,
