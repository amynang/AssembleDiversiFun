...
represent soil organisms from nematodes to small mammals. We arranged
...
rate, scaled to the growth rate $r$ of the smallest basal species. The second
term describes losses to consumption, where $B_j$ is the biomass of consumer
$j$, $y_j$ is the maximum feeding rate of $j$ relative to its metabolic rate and
$F_{ij}$ is the per unit biomass feeding rate of species $j$ on species $i$.
...
animal similarity and high interspecific plant competition. (b) The difference
in productivity relative to (a) when plants compete less with other species but
stronger with conspecifics. (c) The additional difference in productivity when
animals are less similar to each other. (d) The difference in productivity
relative to (a) when plants compete less overall. (e) The additional difference
in productivity when animals are less similar to each other. Black points are
mean values, thick black lines represent the 75% density interval, thin black
lines the 95% density interval.](images/primaryprod4.png){#fig:productivity}
...
different levels of initial plant richness for communities with unrestricted
animal similarity and high interspecific plant competition. (b) The difference
in herbivory pressure relative to (a) when plants compete less with other
species but stronger with conspecifics. (c) The additional difference in
herbivory pressure when animals are less similar to each other. (d) The
difference in herbivory pressure relative to (a) when plants compete less
overall. (e) The additional difference in herbivory pressure when animals are
less similar to each other. Black points are mean values, thick black lines
represent the 75% density interval, thin black lines the 95% density interval.
(d) excludes an outlier of 0.57.](images/pressure4.png)
...
for herbivores). (a) Herbivore control at different levels of initial plant
richness for communities with unrestricted animal similarity and high
interspecific plant competition. (b) The difference in herbivore control
relative to (a) when plants compete less with other species but stronger with
conspecifics. (c) The additional difference in herbivore control when animals
are less similar to each other. (d) The difference in erbivore control relative
to (a) when plants compete less overall. (e) The additional difference in
herbivore control when animals are less similar to each other. Black points are
mean values, thick black lines represent the 75% density interval, thin black
lines the 95% density interval.](images/control4.png)
