...
delta = properties %>% 
  ...
  summarise(plant.rich = first(plant.rich),
            d2_1 = primary.productivity[scenario == s2] - primary.productivity[scenario == s1],
            d3_1 = primary.productivity[scenario == s3] - primary.productivity[scenario == s1],
            d4_1 = primary.productivity[scenario == s4] - primary.productivity[scenario == s1],
            d5_1 = primary.productivity[scenario == s5] - primary.productivity[scenario == s1],
            d6_1 = primary.productivity[scenario == s6] - primary.productivity[scenario == s1],
            d3_2 = primary.productivity[scenario == s3] - primary.productivity[scenario == s2],
            d4_2 = primary.productivity[scenario == s4] - primary.productivity[scenario == s2],
            d5_2 = primary.productivity[scenario == s5] - primary.productivity[scenario == s2],
            d6_2 = primary.productivity[scenario == s6] - primary.productivity[scenario == s2],
            d4_3 = primary.productivity[scenario == s4] - primary.productivity[scenario == s3],
            d5_3 = primary.productivity[scenario == s5] - primary.productivity[scenario == s3],
            d6_3 = primary.productivity[scenario == s6] - primary.productivity[scenario == s3],
            d5_4 = primary.productivity[scenario == s5] - primary.productivity[scenario == s4],
            d6_4 = primary.productivity[scenario == s6] - primary.productivity[scenario == s4],
            d6_5 = primary.productivity[scenario == s6] - primary.productivity[scenario == s5])
...
a = ggplot(properties, 
           aes((plant.rich), primary.productivity,
