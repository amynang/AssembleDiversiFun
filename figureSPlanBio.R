...
delta = properties %>% 
  ...
  summarise(plant.rich = first(plant.rich),
            d2_1 = plant.biomass[scenario == s2] - plant.biomass[scenario == s1],
            d3_1 = plant.biomass[scenario == s3] - plant.biomass[scenario == s1],
            d4_1 = plant.biomass[scenario == s4] - plant.biomass[scenario == s1],
            d5_1 = plant.biomass[scenario == s5] - plant.biomass[scenario == s1],
            d6_1 = plant.biomass[scenario == s6] - plant.biomass[scenario == s1],
            d3_2 = plant.biomass[scenario == s3] - plant.biomass[scenario == s2],
            d4_2 = plant.biomass[scenario == s4] - plant.biomass[scenario == s2],
            d5_2 = plant.biomass[scenario == s5] - plant.biomass[scenario == s2],
            d6_2 = plant.biomass[scenario == s6] - plant.biomass[scenario == s2],
            d4_3 = plant.biomass[scenario == s4] - plant.biomass[scenario == s3],
            d5_3 = plant.biomass[scenario == s5] - plant.biomass[scenario == s3],
            d6_3 = plant.biomass[scenario == s6] - plant.biomass[scenario == s3],
            d5_4 = plant.biomass[scenario == s5] - plant.biomass[scenario == s4],
            d6_4 = plant.biomass[scenario == s6] - plant.biomass[scenario == s4],
            d6_5 = plant.biomass[scenario == s6] - plant.biomass[scenario == s5])

prop = delta %>% group_by(plant.rich) %>% 
  summarise(pp2_1 = sum(d2_1>0)/n(),
            pp3_1 = sum(d3_1>0)/n(),
            pp4_1 = sum(d4_1>0)/n(),
            pp5_1 = sum(d5_1>0)/n(),
            pp6_1 = sum(d6_1>0)/n(),
...
a = ggplot(properties, 
  ...
  theme_modern()+ 
  theme(plot.margin = unit(c(5.5, 5.5, 5.5, 15.5), "pt"),
...
p = ggplot(delta[,1:4] %>% pivot_longer(3:4,
  ...
  #                   point_size = 2
  #) +
  geom_hline(yintercept = 0, linetype = "solid", color = "#dda64a", linewidth = 1.25) +
  geom_smooth(#color = "#618d7a"
    aes(color = which), linewidth = 1.25,
    show.legend = F) +
  scale_color_manual(values = c("#b6543e","#618d7a")) +
  labs(y = expression(delta~"-biomass"),
       x = "Initial plant richness") +
  coord_equal(ratio = 16/6.5) +
...
ggdraw(cow_pres + 
         ...
         draw_image(i5_2,
                    x = .467, y = -.265,
                    scale = .055) +
         draw_grob(rectGrob(x = .5075, y = .395,
                            width = .11,
                            height = .11,
                            gp = gpar(col = "#b6543e",
                                      fill = alpha("white", 0),
